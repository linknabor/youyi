...
public class UserGroupService {
	 ...
	 * @return 分组ID
	 */
	public static String createGroup(String groupName,String accessToken) {

		String id = null;

		String data = "{\"group\":{\"name\":\"" + groupName + "\"}}";

		WechatResponse jsonObject = WeixinUtil.httpsRequest(CREATE_GROUP_URL, "POST", data,accessToken);
	 ...
	 * @return 分组列表
	 */
	public static List<UserGroup> getGroup(String accessToken) {

		List<UserGroup> list = new ArrayList<UserGroup>();
		WechatResponse jsonObject = WeixinUtil.httpsRequest(GET_GROUP_URL, "POST", null,accessToken);
		if (null != jsonObject && jsonObject.getErrcode() == 0
